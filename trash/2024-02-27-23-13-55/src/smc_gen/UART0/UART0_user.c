...
/***********************************************************************************************************************
* File Name        : UART0_user.c
* Component Version: 1.5.0
* Device(s)        : R5F12068xSP
* Description      : This file implements device driver for UART0.
***********************************************************************************************************************/
/***********************************************************************************************************************
Includes
***********************************************************************************************************************/
...
static uint8_t uart_receive_status=0;
/* End user code. Do not edit comment generated here */

/***********************************************************************************************************************
* Function Name: R_UART0_Create_UserInit
* Description  : This function adds user code after initializing UART0.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_UART0_Create_UserInit(void)
{
...
{
    /* Start user code for r_UART0_callback_sendend. Do not edit comment generated here */
	uart_status=1;
    /* End user code. Do not edit comment generated here */
}
...
{
    /* Start user code for r_UART0_callback_receiveend. Do not edit comment generated here */
...
{
    /* Start user code for r_UART0_callback_error. Do not edit comment generated here */
    /* End user code. Do not edit comment generated here */
}
...
{
    /* Start user code for r_UART0_callback_softwareoverrun. Do not edit comment generated here */
...
void uart_send(char* send_data){
	R_UART0_Send((uint8_t*)send_data,strlen(send_data));
	while(1){
		if(uart_status==1){
			uart_status=0;
			break;
